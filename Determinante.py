...
def determinante_matriz(matriz, nivel=0):
    ...
    if len(matriz) == 2:
        ...
        print(f"{'  ' * nivel}Paso 1: {matriz[0][0]} * {matriz[1][1]} - {matriz[0][1]} * {matriz[1][0]} = {det}")
        return det
    ...
    for c in range(len(matriz)):
        ...
        print(f"{'  ' * nivel}Paso {c+1}: Cofactor = {cofactor}, Subdeterminante = {sub_det}, Resultado parcial = {calculo}")
